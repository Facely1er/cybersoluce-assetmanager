          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700 p-8 md:p-12">
            <div className="flex items-center gap-3 mb-6">
              <div className="bg-command-blue-100 dark:bg-command-blue-900/30 p-3 rounded-lg">
                <ShieldAlert className="h-6 w-6 text-command-blue-600 dark:text-command-blue-400" />
              </div>
              <div>
            ...
            <div className="prose prose-gray dark:prose-invert max-w-none">
              ...
              <section className="mb-8">
                <h2 className="text-2xl font-semibold text-gray-900 dark:text-white mb-4">1 Purpose and Scope</h2>
              ...
              <section className="mb-8">
                <h2 className="text-2xl font-semibold text-gray-900 dark:text-white mb-4">2 Prohibited Activities</h2>
                
                <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-3 mt-6">2.1 Illegal Activities</h3>
                <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-3">You may not use the Services to:</p>
                ...
                <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-3">You may not upload, transmit, or distribute:</p>
                <ul className="list-disc pl-6 text-gray-700 dark:text-gray-300 space-y-2 mb-4">
              ...
              <section className="mb-8">
                <h2 className="text-2xl font-semibold text-gray-900 dark:text-white mb-4">3 Acceptable Security Research</h2>
                ...
                <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-2 font-semibold">Permitted Activities:</p>
                <ul className="list-disc pl-6 text-gray-700 dark:text-gray-300 space-y-2 mb-4">
                  <li>Responsibly report vulnerabilities to <a href="mailto:legal@ermits.com" className="text-command-blue-600 dark:text-command-blue-400 hover:underline">legal@ermits.com</a></li>
                ...
                <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-2 font-semibold mt-4">Required Practices:</p>
                <ul className="list-disc pl-6 text-gray-700 dark:text-gray-300 space-y-2 mb-4">
                ...
                <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-2 font-semibold mt-4">Prohibited Activities:</p>
                <ul className="list-disc pl-6 text-gray-700 dark:text-gray-300 space-y-2 mb-4">
                ...
                <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-3">Authorized use of security tools and malware samples:</p>
                <ul className="list-disc pl-6 text-gray-700 dark:text-gray-300 space-y-2 mb-4">
              ...
              <section className="mb-8">
                <h2 className="text-2xl font-semibold text-gray-900 dark:text-white mb-4">4 Federal Contractor and CUI/FCI Handling</h2>
                
                <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-3 mt-6">4.1 CUI Marking and Handling</h3>
                <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-3">Users processing CUI or FCI must:</p>
                <ul className="list-disc pl-6 text-gray-700 dark:text-gray-300 space-y-2 mb-4">
              ...
              <section className="mb-8">
                <h2 className="text-2xl font-semibold text-gray-900 dark:text-white mb-4">5 Resource Limits and Fair Use</h2>
                
                <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-3 mt-6">5.1 Resource Quotas</h3>
                <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-3">Services include resource limits based on your subscription tier:</p>
                <ul className="list-disc pl-6 text-gray-700 dark:text-gray-300 space-y-2 mb-4">
                ...
                <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-3">You agree to use resources reasonably and not to:</p>
                <ul className="list-disc pl-6 text-gray-700 dark:text-gray-300 space-y-2 mb-4">
                ...
                <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-3">ERMITS may, at its discretion:</p>
                <ul className="list-disc pl-6 text-gray-700 dark:text-gray-300 space-y-2 mb-4">
              ...
              <section className="mb-8">
                <h2 className="text-2xl font-semibold text-gray-900 dark:text-white mb-4">6 Reporting Violations</h2>
                
                <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-3 mt-6">6.1 How to Report</h3>
                <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-3">If you become aware of violations of this AUP:</p>
                <ul className="list-disc pl-6 text-gray-700 dark:text-gray-300 space-y-2 mb-4">
                  <li><strong>Email:</strong> <a href="mailto:legal@ermits.com" className="text-command-blue-600 dark:text-command-blue-400 hover:underline">legal@ermits.com</a> (Subject: "AUP Violation Report")</li>
                ...
                <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-3">ERMITS will not take adverse action against users who:</p>
                <ul className="list-disc pl-6 text-gray-700 dark:text-gray-300 space-y-2 mb-4">
                ...
                <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-3">Making false or malicious reports is prohibited and may result in:</p>
                <ul className="list-disc pl-6 text-gray-700 dark:text-gray-300 space-y-2 mb-4">
              ...
              <section className="mb-8">
                <h2 className="text-2xl font-semibold text-gray-900 dark:text-white mb-4">7 Enforcement and Consequences</h2>
                
                <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-3 mt-6">7.1 Investigation</h3>
                <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-3">ERMITS may investigate suspected violations by:</p>
                <ul className="list-disc pl-6 text-gray-700 dark:text-gray-300 space-y-2 mb-4">
                ...
                <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-3">Depending on violation severity, ERMITS may:</p>
                
                <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-2 font-semibold mt-4">Warning:</p>
                <ul className="list-disc pl-6 text-gray-700 dark:text-gray-300 space-y-2 mb-4">
                ...
                <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-2 font-semibold mt-4">Temporary Suspension:</p>
                <ul className="list-disc pl-6 text-gray-700 dark:text-gray-300 space-y-2 mb-4">
                ...
                <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-2 font-semibold mt-4">Permanent Termination:</p>
                <ul className="list-disc pl-6 text-gray-700 dark:text-gray-300 space-y-2 mb-4">
                ...
                <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-2 font-semibold mt-4">Legal Action:</p>
                <ul className="list-disc pl-6 text-gray-700 dark:text-gray-300 space-y-2 mb-4">
                ...
                <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-3">If you believe an enforcement action was made in error:</p>
                <ul className="list-disc pl-6 text-gray-700 dark:text-gray-300 space-y-2 mb-4">
                  <li>Contact <a href="mailto:legal@ermits.com" className="text-command-blue-600 dark:text-command-blue-400 hover:underline">legal@ermits.com</a> (Subject: "AUP Enforcement Appeal")</li>
              ...
              <section className="mb-8">
                <h2 className="text-2xl font-semibold text-gray-900 dark:text-white mb-4">8 Cooperation with Law Enforcement</h2>
                
                <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-3 mt-6">8.1 Legal Requests</h3>
                <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-3">ERMITS will cooperate with lawful requests from:</p>
                <ul className="list-disc pl-6 text-gray-700 dark:text-gray-300 space-y-2 mb-4">
                ...
                <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-3">When legally permitted, ERMITS will:</p>
                <ul className="list-disc pl-6 text-gray-700 dark:text-gray-300 space-y-2 mb-4">
                ...
                <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-3">In emergencies involving imminent threat to life or serious bodily harm:</p>
                <ul className="list-disc pl-6 text-gray-700 dark:text-gray-300 space-y-2 mb-4">
              ...
              <section className="mb-8">
                <h2 className="text-2xl font-semibold text-gray-900 dark:text-white mb-4">9 Third-Party Services and Integrations</h2>
                <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-3">When using third-party integrations through ERMITS Services:</p>
                <ul className="list-disc pl-6 text-gray-700 dark:text-gray-300 space-y-2 mb-4">
              ...
              <section className="mb-8">
                ...
                <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-3">ERMITS may update this AUP to reflect:</p>
                <ul className="list-disc pl-6 text-gray-700 dark:text-gray-300 space-y-2 mb-4">
                ...
                <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-2 font-semibold mt-4">Notification:</p>
                <ul className="list-disc pl-6 text-gray-700 dark:text-gray-300 space-y-2 mb-4">
              ...
              <section className="mb-8">
                ...
                <div className="space-y-3 text-gray-700 dark:text-gray-300">
                  ...
                  Email: <a href="mailto:legal@ermits.com" className="text-command-blue-600 dark:text-command-blue-400 hover:underline">legal@ermits.com</a><br />
