            ...
            <div className="prose prose-gray dark:prose-invert max-w-none">
              ...
              <section className="mb-8">
                ...
                <ul className="list-disc pl-6 text-gray-700 dark:text-gray-300 space-y-2 mb-4">
                  ...
                  <li><strong>ERMITS Advisory + STEEL™:</strong> Strategic assessments, vCISO services, compliance advisory</li>
              ...
              <section className="mb-8">
                ...
                <ul className="list-disc pl-6 text-gray-700 dark:text-gray-300 space-y-2 mb-4">
                  ...
                  <li><strong>"Advisory Services"</strong> means professional consulting, strategic guidance, assessments, and expert recommendations provided by ERMITS personnel or contractors.</li>
                  <li><strong>"Digital Products"</strong> means self-service downloadable or web-based tools, templates, assessments, and resources available for immediate purchase and use without professional consulting.</li>
                </ul>
              </section>
              ...
              <section className="mb-8">
                ...
                <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-3">
                  ERMITS products and services are tools to assist with security and compliance efforts but do not guarantee compliance with any regulatory framework, do not constitute legal or professional consulting advice (except where Advisory Services explicitly provide such advice), and do not replace qualified security assessments or professional audits.
                </p>
              </section>
              ...
              <section className="mb-8">
                ...
                <p className="text-gray-700 dark:text-gray-300 leading-relaxed mb-3">
                  For Advisory Services, total liability is capped at fees paid for the specific advisory engagement giving rise to the claim.
                </p>
              </section>
              ...
              <section className="mb-8">
                ...
                <div className="space-y-3 text-gray-700 dark:text-gray-300">
                  ...
                  <p><strong>For advisory services inquiries:</strong><br />
                  Email: <a href="mailto:advisory@ermits.com" className="text-command-blue-600 dark:text-command-blue-400 hover:underline">advisory@ermits.com</a><br />
                  Website: <a href="https://www.ermits-advisory.com" target="_blank" rel="noopener noreferrer" className="text-command-blue-600 dark:text-command-blue-400 hover:underline">www.ermits-advisory.com</a></p>
                </div>
              </section>
            </div>
          </div>
