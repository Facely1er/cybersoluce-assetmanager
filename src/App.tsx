      ...
      <ThemeProvider>
        <AuthProvider>
          <AssetInventoryProvider>
            <BrowserRouter>
              <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-gray-50 dark:from-gray-900 dark:via-gray-900 dark:to-gray-950 font-inter" role="main">
                {/* Global Toaster */}
                <Toaster 
                  position="top-right"
                  toastOptions={{
